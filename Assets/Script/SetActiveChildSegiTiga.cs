...
{
    public class SetActiveChildSegiTiga : MonoBehaviour
    {
        ...
        public float timeChangeSudut0 = 10.0f;
        public float timeChangeSudut1 = 12.0f;
        public float timeChangeSudut2 = 14.0f;

        [Tooltip("Duration time looping for each part?")]
        public float timeEndSisi = 8.0f;
        public float timeEndSudut = 16.0f;

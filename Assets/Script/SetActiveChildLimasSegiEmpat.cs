...
{
    public class SetActiveChildLimasSegiEmpat : MonoBehaviour
    {
        ...
        public float timeChangeRusuk0 = 28.0f;
        public float timeChangeRusuk1 = 30.0f;
        public float timeChangeRusuk2 = 32.0f;
        public float timeChangeRusuk3 = 34.0f;
        public float timeChangeRusuk4 = 36.0f;
        public float timeChangeRusuk5 = 38.0f;
        public float timeChangeRusuk6 = 40.0f;
        public float timeChangeRusuk7 = 42.0f;


        [Tooltip("Duration time looping for each part?")]
        public float timeEndSisi = 14.0f;
        public float timeEndSudut = 28.0f;
        public float timeEndRusuk = 46.0f;
